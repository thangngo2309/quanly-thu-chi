...
export function ExpensesManagement() {
  ...
  const searchContent = (
    <>
      ...
      <HDatePicker<ExpensesSearchValues>
        name="fromDate"
        label="Từ ngày"
      />
